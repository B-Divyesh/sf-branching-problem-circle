...
| Copy unit | Words | Purpose / claim coverage |
| --- | ---: | --- |
| Skip to the circle | 4 | Skip link |
| Branching Problem Circle | 3 | Wordmark |
| Demo | 1 | Navigation |
| How it works | 3 | Navigation and section heading |
...
| Built for one shared device | 6 | Operating model; `single-device` |
| No public sharing, child accounts, rankings, test banks, or generated solutions. | 10 | Limits; `no-public-sharing` |
...
| Seed visual, algebraic, and pattern-seeking approaches. | 6 | Template description |
| Compare failed approaches | 3 | Template name |
| Preserve two tempting starts and one reframing move. | 8 | Template description |
| What cannot change? | 3 | Template name |
| Organize experiments around invariants, parity, and bounds. | 7 | Template description |
| From hunch to proof | 4 | Template name |
